...
namespace SCP682Exiled
{
    public class Config : IConfig
    {
        ...
        [Description("max ahp")]
        public int MaxAHP { get; set; } = 2000;
        [Description("every how many seconds SCP-682 health should regenerate?")]
        public int heal_time { get; set; } = 5;
        [Description("how much ahp should be regenerated")]
        public int RegAHP { get; set; } = 5;
        [Description("every how many seconds SCP-682 AHP should regenerate")]
        public int ahp_time { get; set; } = 1;
